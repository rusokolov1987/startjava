public class IfElseStatementTheme {
    public static void main(String[] args) {
        ...
        System.out.println("\n#4. Поиск одинаковых цифр в числах");
            ...
            if (num4 / 100 != num5 / 100 && num4 / 10 % 10 != num5 / 10 % 10 && num4 % 10 != num5 % 10) {
                ...
                if (num4 / 100 == num5 / 100) {
                    System.out.println("Числа " + num4 + " и " + num5 + " имеют одинаковую цифру = " + num4 / 100 + " в разряде #3");
                }
                if (num4 / 10 % 10 == num5 / 10 % 10) {
                    System.out.println("Числа " + num4 + " и " + num5 + " имеют одинаковую цифру = " +  num4 / 10 % 10 + " в разряде #2");
                }
                if (num4 % 10 == num5 % 10) {
                    System.out.println("Числа " + num4 + " и " + num5 + " имеют одинаковую цифру = " + num4 % 10 + " в разряде #1");
                }
            }
        ...
        System.out.println("\n#6. Подсчет суммы вклада и начисленных банком %");
            ...
            System.out.println("Total deposit = " + depositTotal + "; accrued interest = " + accruedInterest + "; total = " + (depositTotal + accruedInterest));
            ...
            System.out.println("\n#7. Определение оценки по предметам");
                ...
                System.out.println("Средний балл по предметам " + (double) (historyScore + programmingScore) / 2);
            ...
            System.out.println("\n#9. Подсчет количества банкнот");
                ...
                if ((banknoteHundred * 100 + banknoteTen * 10 + banknoteOne) >= money) {
                    ...
                    System.out.println("100 USD = " + banknoteHundred + " total = " + banknoteHundred * 100 + "; 10 USD = " + banknoteTen + " total = " + banknoteTen * 10 + "; 1 USD = " + 
                                        banknoteOne + " total = " + banknoteOne);
                } else {
